    ...
    module top_test_gen #(
        ...
        parameter FACE_CULLER_ENABLE = 1'b0,
...
tri_mem_wr_addr = 'd5;
#(PERIOD);
tri_mem_wr_data = 'h43104a68;
tri_mem_wr_addr = 'd6;
#(PERIOD);
tri_mem_wr_data = 'h42d2920b;
tri_mem_wr_addr = 'd7;
#(PERIOD);
tri_mem_wr_data = 'h40e00000;
tri_mem_wr_addr = 'd8;
#(PERIOD);
...
tri_mem_wr_addr = 'd13;
#(PERIOD);
tri_mem_wr_data = 'h4320de7b;
tri_mem_wr_addr = 'd14;
#(PERIOD);
tri_mem_wr_data = 'h431cc07c;
tri_mem_wr_addr = 'd15;
#(PERIOD);
tri_mem_wr_data = 'h3f800000;
tri_mem_wr_addr = 'd16;
...
tri_mem_wr_addr = 'd21;
#(PERIOD);
tri_mem_wr_data = 'h42ceeb4e;
tri_mem_wr_addr = 'd22;
#(PERIOD);
tri_mem_wr_data = 'h433d647c;
tri_mem_wr_addr = 'd23;
#(PERIOD);
tri_mem_wr_data = 'h3f800000;
tri_mem_wr_addr = 'd24;
...
tri_mem_wr_addr = 'd29;
#(PERIOD);
tri_mem_wr_data = 'h4205b61c;
tri_mem_wr_addr = 'd30;
#(PERIOD);
tri_mem_wr_data = 'h429cfa1c;
tri_mem_wr_addr = 'd31;
#(PERIOD);
tri_mem_wr_data = 'h3f800000;
tri_mem_wr_addr = 'd32;
...
tri_mem_wr_addr = 'd37;
#(PERIOD);
tri_mem_wr_data = 'h429f9044;
tri_mem_wr_addr = 'd38;
#(PERIOD);
tri_mem_wr_data = 'h42828e57;
tri_mem_wr_addr = 'd39;
#(PERIOD);
tri_mem_wr_data = 'h3f800000;
tri_mem_wr_addr = 'd40;
...
tri_mem_wr_addr = 'd45;
#(PERIOD);
tri_mem_wr_data = 'h429f319d;
tri_mem_wr_addr = 'd46;
#(PERIOD);
tri_mem_wr_data = 'hbf831fbe;
tri_mem_wr_addr = 'd47;
#(PERIOD);
tri_mem_wr_data = 'h40e00000;
tri_mem_wr_addr = 'd48;
